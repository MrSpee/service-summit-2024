...
END:VCALENDAR`
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white py-6 sm:py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
          {/* Header Section */}
          <div className="text-center space-y-3 sm:space-y-4">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-blue-600 leading-tight">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-lg sm:text-xl md:text-2xl">Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-base sm:text-lg">Veranstaltungsort</h3>
                  <p className="text-sm sm:text-base text-gray-600">Deloitte Stand, Service Summit Hamburg</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-base sm:text-lg">Dauer</h3>
                  <p className="text-sm sm:text-base text-gray-600">ca. 10 Minuten</p>
                </div>
              </div>

              {/* Schedule */}
              <div className="flex items-start space-x-3">
                <CalendarDays className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 mt-1 flex-shrink-0" />
                <div className="w-full">
                  <h3 className="font-semibold text-base sm:text-lg mb-2">Termine</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {sessions.map((session, index) => (
                      <Card key={index} className="bg-gray-50">
                        <CardHeader className="p-3 sm:p-4">
                          <CardTitle className="text-base sm:text-lg text-blue-600">{session.day}, {session.date}</CardTitle>
                        </CardHeader>
                            ...
                            {session.times.map((time, timeIndex) => (
                              <li key={timeIndex} className="bg-white p-2 rounded-md shadow-sm">
                                <div className="flex justify-between items-center">
                                  <span className="text-sm sm:text-base">{time.start} Uhr</span>
                                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                                    ...
                                    <DialogContent className="w-[90vw] max-w-[425px] sm:w-full">
                                      <DialogHeader>
                                        <DialogTitle className="text-base sm:text-lg">Zum Kalender hinzufügen</DialogTitle>
                                      </DialogHeader>
                                      <div className="py-4">
                                        <p className="text-sm sm:text-base">Wählen Sie Ihren bevorzugten Kalender-Service:</p>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-lg sm:text-xl md:text-2xl text-blue-600">Warum lohnt sich dieser Vortrag?</CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-700 mt-4">
